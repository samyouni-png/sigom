...
- `assets/scripts/app.js` : navigation mobile, ancres, état actif, révélations progressives et validation du formulaire.
- `assets/images/` : visuels architecturaux, favicon et variantes WebP/PNG.
